...
void Trigger_T1(){
	...
	nnp++;
        ...
        gDp_T1->SetMarkerSize(1.7);
        gHeD_T1->SetMarkerStyle(8);
        gHeD_T1->SetMarkerColor(8);
        gHeD_T1->SetMarkerSize(1.7);
        gH3D_T1->SetMarkerStyle(8);
        gH3D_T1->SetMarkerColor(4);
        gH3D_T1->SetMarkerSize(1.7);
        gH3He_T1->SetMarkerStyle(8);
        gH3He_T1->SetMarkerColor(2);
        gH3He_T1->SetMarkerSize(1.7);

        gStyle->SetTitleY(0.1);
	...
	pad1->SetBottomMargin(0.15);
        ...
        mg->GetHistogram()->SetTitle("(a) T1/T4 efficiency");
	mg->GetYaxis()->SetRangeUser(0.985,0.991);

        auto leg1=new TLegend(0.75,0.65,0.9,0.9);
	...
	pad2->SetBottomMargin(0.15);
        ...
        mg4->GetHistogram()->SetTitle("(b) T1/T4 efficiency ratio");
	mg4->GetYaxis()->SetRangeUser(0.995,1.005);

        auto leg4=new TLegend(0.75,0.65,0.9,0.9);
