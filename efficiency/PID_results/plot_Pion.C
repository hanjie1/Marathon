void plot_Pion(){
    ...
    while(tmp.ReadLine(infile)){
          ...
          tmp.Tokenize(content,from,"  ");
          H1_pet[nn-1]=atof(content.Data());
          tmp.Tokenize(content,from,"  ");
          H1_pec[nn-1]=atof(content.Data());
          tmp.Tokenize(content,from,"  ");
          D2_pet[nn-1]=atof(content.Data());
          tmp.Tokenize(content,from,"  ");
          D2_pec[nn-1]=atof(content.Data());
          tmp.Tokenize(content,from,"  ");
          He_pet[nn-1]=atof(content.Data());
          tmp.Tokenize(content,from,"  ");
          He_pec[nn-1]=atof(content.Data());
          tmp.Tokenize(content,from,"  ");
          H3_pet[nn-1]=atof(content.Data());
          tmp.Tokenize(content,from,"  ");
    ...
    TGraph *gH1_pec=new TGraph(12,kin,H1_pec);
    TGraph *gD2_pec=new TGraph(12,kin,D2_pec);
    TGraph *gHe_pec=new TGraph(12,kin,He_pec);
    TGraph *gH3_pec=new TGraph(12,kin,H3_pec);
