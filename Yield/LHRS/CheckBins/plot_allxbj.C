void plot_allxbj()
{
    ...
    THStack *hsH1=new THStack("hsH1","xbj distribution");
    ...
    THStack *hsD2=new THStack("hsD2","xbj distribution");
    for(int ii=0;ii<11;ii++){
        hsD2->Add(hD2[ii]);
    ...
    THStack *hsH3=new THStack("hsH3","xbj distribution");
    for(int ii=0;ii<11;ii++){
        hsH3->Add(hH3[ii]);
    ...
    THStack *hsHe3=new THStack("hsHe3","xbj distribution");
    for(int ii=0;ii<11;ii++){
        hsHe3->Add(hHe3[ii]);
