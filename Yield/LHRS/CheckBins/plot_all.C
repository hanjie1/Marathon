...
//	 hH3[ii]->Rebin(20);
	...
	hH1[ii]->SetLineColor(color[ii]);
        ...
        H1Fbin[ii]=hH1[ii]->GetXaxis()->GetBinLowEdge(hH1[ii]->FindFirstBinAbove(tmp_th));
        H1Lbin[ii]=hH1[ii]->GetXaxis()->GetBinUpEdge(hH1[ii]->FindLastBinAbove(tmp_th));
     }
	...
	hD2[ii]->SetLineColor(color[ii]);
        ...
        Double_t tmp_th=tmp_max*0.25;
        D2Fbin[ii]=hD2[ii]->GetXaxis()->GetBinLowEdge(hD2[ii]->FindFirstBinAbove(tmp_th));
        D2Lbin[ii]=hD2[ii]->GetXaxis()->GetBinUpEdge(hD2[ii]->FindLastBinAbove(tmp_th));
     }
	...
	hHe3[ii]->SetLineColor(color[ii]);
        ...
        Double_t tmp_th=tmp_max*0.25;
        HeFbin[ii]=hHe3[ii]->GetXaxis()->GetBinLowEdge(hHe3[ii]->FindFirstBinAbove(tmp_th));
        HeLbin[ii]=hHe3[ii]->GetXaxis()->GetBinUpEdge(hHe3[ii]->FindLastBinAbove(tmp_th));
     }
	...
	hH3[ii]->SetLineColor(color[ii]);
        ...
        Double_t tmp_th=tmp_max*0.25;
        H3Fbin[ii]=hH3[ii]->GetXaxis()->GetBinLowEdge(hH3[ii]->FindFirstBinAbove(tmp_th));
        H3Lbin[ii]=hH3[ii]->GetXaxis()->GetBinUpEdge(hH3[ii]->FindLastBinAbove(tmp_th));
     }
  
    ofstream myfile;
    myfile.open("Xrange_newbin.txt");
    myfile<<"---------- H1 ----------"<<endl;
    for(int ii=0;ii<5;ii++){
