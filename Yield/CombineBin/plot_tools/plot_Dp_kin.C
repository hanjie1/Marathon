...
void plot_Dp_kin()
{
     ...
     Double_t H1_Radx[5][MAXBIN],H1_RadQ2[5][MAXBIN];
     Double_t D2_Radx[5][MAXBIN],D2_RadQ2[5][MAXBIN];
     Double_t H1_RadCor[5][MAXBIN]; 
	 ...
	 for(int jj=0;jj<MAXBIN;jj++){
             ...
             H1_Radx[ii][jj]=0.0; H1_RadQ2[ii][jj]=0.0; 
...
//       ReadYield(Yfile,ii,H1_x1,H1_xavg1,H1_Q21,H1_Y1,H1_YE1);
   ...
   for(int ii=0;ii<5;ii++){
	   ...
	   if(abs(D2_xavg[ii][jj]-D2_Radx[ii][jj])<0.0001){
	      Dp_RadCor[ii][jj]=H1_RadCor[ii][jj]/D2_RadCor[ii][jj];
	   }
