...
const double bH3_A=0.00021;//0.0001293;//0.00021;
const double bH3_B=-0.00893;//-0.007399;//-0.00893;

const double bHe3_A=0.00006;//0.00008686;//0.00006;
const double bHe3_B=-0.00392;//-0.004759;//-0.00392;
