...
void Allkin_CalcRawYield(){
   ...
   for(int nn=0;nn<2;nn++){   
    ...
    ofstream myfile;
    myfile.open(Form("RawYield/test002_vz007/%s_kin%d.txt",target[nn].Data(),kin[mm]));
    myfile<<"n   xbj   Q2   Yield   Yield_err"<<endl;
     ...
     Double_t tmpRawNe[35]={0.0};
     Double_t totalQ2[35]={0.0};
     Double_t tmpQ2[35]={0.0};
     Double_t totalXbj[35]={0.0};
     Double_t tmpXbj[35]={0.0};
...
/*             if(isrenewed){
               Double_t current=dnew_r*gain+offset;
               for(int kk=0;kk<nBin;kk++){
                 if(current>4){
                    totalNe[kk]+=tmpTotalNe[kk];
                    NNe[kk]+=tmpNNe[kk];
                    RawNe[kk]+=tmpRawNe[kk];
       		    totalQ2[kk]+=tmpQ2[kk];
		    totalXbj[kk]+=tmpXbj[kk];
                 }
                 tmpTotalNe[kk]=0;
                 tmpRawNe[kk]=0;
                 tmpQ2[kk]=0;
