void plot_cer()
{
     ...
     hcer0->Draw("AP");
     hcer0->SetTitle("RHRS cer1;run number;single photon peak");

     TCanvas *c2=new TCanvas("c2");
     hcer1->SetMarkerStyle(8);
     hcer1->SetMarkerColor(4);
     hcer1->Draw("AP");
     hcer1->SetTitle("RHRS cer2;run number;single photon peak");

     TCanvas *c3=new TCanvas("c3");
     hcer2->SetMarkerStyle(8);
     hcer2->SetMarkerColor(4);
     hcer2->Draw("AP");
     hcer2->SetTitle("RHRS cer3;run number;single photon peak");

     TCanvas *c4=new TCanvas("c4");
     hcer3->SetMarkerStyle(8);
     hcer3->SetMarkerColor(4);
     hcer3->Draw("AP");
     hcer3->SetTitle("RHRS cer4;run number;single photon peak");

     TCanvas *c5=new TCanvas("c5");
     hcer4->SetMarkerStyle(8);
     hcer4->SetMarkerColor(4);
     hcer4->Draw("AP");
     hcer4->SetTitle("RHRS cer5;run number;single photon peak");

     TCanvas *c6=new TCanvas("c6");
     hcer5->SetMarkerStyle(8);
     hcer5->SetMarkerColor(4);
     hcer5->Draw("AP");
     hcer5->SetTitle("RHRS cer6;run number;single photon peak");

     TCanvas *c7=new TCanvas("c7");
     hcer6->SetMarkerStyle(8);
     hcer6->SetMarkerColor(4);
     hcer6->Draw("AP");
     hcer6->SetTitle("RHRS cer7;run number;single photon peak");

     TCanvas *c8=new TCanvas("c8");
     hcer7->SetMarkerStyle(8);
     hcer7->SetMarkerColor(4);
     hcer7->Draw("AP");
     hcer7->SetTitle("RHRS cer8;run number;single photon peak");

     TCanvas *c9=new TCanvas("c9");
     hcer8->SetMarkerStyle(8);
     hcer8->SetMarkerColor(4);
     hcer8->Draw("AP");
     hcer8->SetTitle("RHRS cer9;run number;single photon peak");

     TCanvas *c10=new TCanvas("c10");
     hcer9->SetMarkerStyle(8);
     hcer9->SetMarkerColor(4);
     hcer9->Draw("AP");
     hcer9->SetTitle("RHRS cer10;run number;single photon peak");
