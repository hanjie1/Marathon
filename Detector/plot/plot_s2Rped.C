void plot_s2Rped()
{
     ...
     hs2R0->Draw("AP");
     hs2R0->SetTitle("LHRS s2R1;run number;pedestal");

     TCanvas *c2=new TCanvas("c2");
     hs2R1->SetMarkerStyle(8);
     hs2R1->SetMarkerColor(4);
     hs2R1->Draw("AP");
     hs2R1->SetTitle("LHRS s2R2;run number;pedestal");

     TCanvas *c3=new TCanvas("c3");
     hs2R2->SetMarkerStyle(8);
     hs2R2->SetMarkerColor(4);
     hs2R2->Draw("AP");
     hs2R2->SetTitle("LHRS s2R3;run number;pedestal");

     TCanvas *c4=new TCanvas("c4");
     hs2R3->SetMarkerStyle(8);
     hs2R3->SetMarkerColor(4);
     hs2R3->Draw("AP");
     hs2R3->SetTitle("LHRS s2R4;run number;pedestal");

     TCanvas *c5=new TCanvas("c5");
     hs2R4->SetMarkerStyle(8);
     hs2R4->SetMarkerColor(4);
     hs2R4->Draw("AP");
     hs2R4->SetTitle("LHRS s2R5;run number;pedestal");

     TCanvas *c6=new TCanvas("c6");
     hs2R5->SetMarkerStyle(8);
     hs2R5->SetMarkerColor(4);
     hs2R5->Draw("AP");
     hs2R5->SetTitle("LHRS s2R6;run number;pedestal");

     TCanvas *c7=new TCanvas("c7");
     hs2R6->SetMarkerStyle(8);
     hs2R6->SetMarkerColor(4);
     hs2R6->Draw("AP");
     hs2R6->SetTitle("LHRS s2R7;run number;pedestal");

     TCanvas *c8=new TCanvas("c8");
     hs2R7->SetMarkerStyle(8);
     hs2R7->SetMarkerColor(4);
     hs2R7->Draw("AP");
     hs2R7->SetTitle("LHRS s2R8;run number;pedestal");

     TCanvas *c9=new TCanvas("c9");
     hs2R8->SetMarkerStyle(8);
     hs2R8->SetMarkerColor(4);
     hs2R8->Draw("AP");
     hs2R8->SetTitle("LHRS s2R9;run number;pedestal");

     TCanvas *c10=new TCanvas("c10");
     hs2R9->SetMarkerStyle(8);
     hs2R9->SetMarkerColor(4);
     hs2R9->Draw("AP");
     hs2R9->SetTitle("LHRS s2R10;run number;pedestal");

     TCanvas *c11=new TCanvas("c11");
     hs2R10->SetMarkerStyle(8);
     hs2R10->SetMarkerColor(4);
     hs2R10->Draw("AP");
     hs2R10->SetTitle("LHRS s2R11;run number;pedestal");

     TCanvas *c12=new TCanvas("c12");
     hs2R11->SetMarkerStyle(8);
     hs2R11->SetMarkerColor(4);
     hs2R11->Draw("AP");
     hs2R11->SetTitle("LHRS s2R12;run number;pedestal");

     TCanvas *c13=new TCanvas("c13");
     hs2R12->SetMarkerStyle(8);
     hs2R12->SetMarkerColor(4);
     hs2R12->Draw("AP");
     hs2R12->SetTitle("LHRS s2R13;run number;pedestal");

     TCanvas *c14=new TCanvas("c14");
     hs2R13->SetMarkerStyle(8);
     hs2R13->SetMarkerColor(4);
     hs2R13->Draw("AP");
     hs2R13->SetTitle("LHRS s2R14;run number;pedestal");

     TCanvas *c15=new TCanvas("c15");
     hs2R14->SetMarkerStyle(8);
     hs2R14->SetMarkerColor(4);
     hs2R14->Draw("AP");
     hs2R14->SetTitle("LHRS s2R15;run number;pedestal");

     TCanvas *c16=new TCanvas("c16");
     hs2R15->SetMarkerStyle(8);
     hs2R15->SetMarkerColor(4);
     hs2R15->Draw("AP");
     hs2R15->SetTitle("LHRS s2R16;run number;pedestal");

     c1->Print("Ls2R_ped.pdf[");
     c1->Print("Ls2R_ped.pdf");
     c2->Print("Ls2R_ped.pdf");
     c3->Print("Ls2R_ped.pdf");
     c4->Print("Ls2R_ped.pdf");
     c5->Print("Ls2R_ped.pdf");
     c6->Print("Ls2R_ped.pdf");
     c7->Print("Ls2R_ped.pdf");
     c8->Print("Ls2R_ped.pdf");
     c9->Print("Ls2R_ped.pdf");
     c10->Print("Ls2R_ped.pdf");
     c11->Print("Ls2R_ped.pdf");
     c12->Print("Ls2R_ped.pdf");
     c13->Print("Ls2R_ped.pdf");
     c14->Print("Ls2R_ped.pdf");
     c15->Print("Ls2R_ped.pdf");
     c16->Print("Ls2R_ped.pdf");
     c16->Print("Ls2R_ped.pdf]");
